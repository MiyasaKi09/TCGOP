...
export const mugiwaraCards: CardDef[] = [
  // === PERSONNAGES ===
  {
    ...
    synergies: [{ partnerId: "MG-002", atkBonus: 2, onPartnerKO: 3 }],
  ...
  },
  {
    ...
    synergies: [{ partnerId: "MG-001", atkBonus: 2, onPartnerKO: 3 }],
  ...
  // === EVENEMENTS ===
  {
    id: "MG-022", name: "Volonte du D", type: "event", cost: 1,
    faction: "pirate", rarity: "C", set: "ST01",
  ...
  {
    id: "MG-025", name: "Tempete", type: "event", cost: 3,
    faction: "pirate", rarity: "U", set: "ST01",
